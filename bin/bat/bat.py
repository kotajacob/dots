...
def main():
    ...
    # printing prefix
    if (ac == True):
        message = "ac:" + str(int(batPercent)) # charging symbol
    else:
        if (int(batPercent) <= 25):
            message = "bat:" + str(int(batPercent)) # empty battery symbol
        elif (int(batPercent) > 25 and int(batPercent) <= 50):
            message = "bat:" + str(int(batPercent)) # low battery symbol
        elif (int(batPercent) > 50 and int(batPercent) <= 75):
            message = "bat:" + str(int(batPercent)) # low battery symbol
        if (int(batPercent) > 75):
            message = "bat:" + str(int(batPercent)) # full battery symbol
