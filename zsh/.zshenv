...
export PATH="$HOME/.local/perl5/bin:$HOME/.local/opt/flutter/bin:$HOME/.local/opt/android-sdk/cmdline-tools/latest/bin:$GOPATH/bin:$NPM_PACKAGES/bin:$HOME/bin:$HOME/.local/bin:$PATH"
